...
int vfsmovedir(char *P1, char *P2) {
    ...
    */
    src_fd = bst_node *bst_find(root_bst , char absolute_path[P1])
    des_fd = bst_node *bst_find(root_bst , char absolute_path[P2])
	...
	*/
    int bst_insert(root_bst, bst_fd_insert );
    int bst_delete(root_bst, bst_fd_del);
	return 0;
}
